...
<button class="btn btn-primary" type="button" onclick="location.href='?page=admin_createStudents.php'">Manage students page</button>
...
//DELETED PHP CALL DATABASE OF SHOWS
    ...
    <?php
        ...
        echo "<li class=\"list-group-item\" style = width : 10%><div class = s_id>STUD ID</div></li>";
        echo "<li class=\"list-group-item\" style = width : 20%><div class = s_name>STUD NAME</div></li>";
        echo "<li class=\"list-group-item\" ><div class = dis>DISABLE SHOW</div></li>";
        
            foreach ($shows as $c){
                echo "<li class=\"list-group-item\" style = width : 10%><div class = show_btn>".$c['show_short_name']."</div></li>";
            }
        echo "</div>";
        echo "</ul>";
            foreach ($stud as $s){
               ...
               // echo "document.getElementById(".$idCheck.").checked = false";
                ...
                echo "<ul class=\"list-group list-group-horizontal\">";
                    ...
                    echo "<li class=\"list-group-item\" style = width : 30%><div class = s_name><a href='?page=admin_studentEdit.php&stud_id=".$s['stud_id']."'>".$s['stud_lname'] .", ". $s['stud_fname']."</a></div></li>";
                    ...
                    echo "<li class=\"list-group-item \" style = width : 5% onChange = 'disabled(".$s['stud_id'].", ".$s['stud_which_show'].", ".$numShows.")' >";
                      //  echo "<div class = dis><input type = \"checkbox\" id = 'dis-".$s['stud_id']."' ".$check." >";
                      echo "<div class = \"dis\">";
                        echo "<div class=\"form-check form-switch\">";
                        echo "<input class=\"form-check-input\" type=\"checkbox\" id = 'dis-".$s['stud_id']."' ".$check." role=\"switch\" >";
                        echo "<label class=\"form-check-label\" for= 'dis-".$s['stud_id']."' ".$check."></label>";
                        echo "</div>";
                        echo "</div>";
                    echo "</li>";
                    $i = 0;
                        foreach ($shows as $c){
                           ...
                           // echo "showId = ".$showsIdArr[$i];
                            ...
                            echo "<li class=\"list-group-item\" ><div class = show_btn>".$toggleBtn."</div></li>";
                        }
                echo "</ul>";
            }
        echo "</form>";
